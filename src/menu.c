...
MAKE_MENU       (main_page,     NULL_ENTRY,     NULL_ENTRY,     NULL_ENTRY,     common_info,    4,          MAIN_PAGE,          "Главное меню");
  ...
  MAKE_MENU     (meas_channels, act_channels,   common_info,    main_page,      meas_ch_0,      14,         MEAS_CHANNELS,      "Изм. каналы");
    MAKE_MENU   (meas_ch_0,     meas_ch_1,      meas_ch_13,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_0,          "Темп. пола");
    ...
    MAKE_MENU   (meas_ch_9,     meas_ch_10,     meas_ch_8,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_9,          "Потребление");
    MAKE_MENU   (meas_ch_10,    meas_ch_11,     meas_ch_9,      meas_channels,  NULL_ENTRY,     0,          MEAS_CH_10,         "Синхр. 0, мкс");
    MAKE_MENU   (meas_ch_11,    meas_ch_12,     meas_ch_10,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_11,         "Синхр. 1, мкс");
    MAKE_MENU   (meas_ch_12,    meas_ch_13,      meas_ch_11,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_12,         "Частота сети, Гц");
    MAKE_MENU   (meas_ch_13,    meas_ch_0,      meas_ch_12,     meas_channels,  NULL_ENTRY,     0,          MEAS_CH_13,         "Задержка включения, мкс");
  MAKE_MENU     (act_channels,  rele_channels,  meas_channels,  main_page,      act_ch_0,       6,          ACT_CHANNELS,       "Настройки");
    MAKE_MENU   (act_ch_0,      act_ch_1,       load_res,       act_channels,   act_en_0,       4,          ACT_CH_0,           "Температура пола");
    ...
    MAKE_MENU   (act_ch_1,      act_ch_2,       act_ch_0,       act_channels,   act_en_1,       4,          ACT_CH_1,           "Температура ключа");
      MAKE_MENU (act_en_1,      act_set_1,      act_cur_1,      act_ch_1,       EDITED_VAL,     0,          ACT_EN_1,           "Управление");
      MAKE_MENU (act_set_1,     act_hyst_1,     act_en_1,       act_ch_1,       EDITED_VAL,     0,          ACT_SET_1,          "Задано");
    ...
    MAKE_MENU   (load_res,      act_ch_0,       ctrl_rule,      act_channels,   EDITED_VAL,     0,          LOAD_RES,           "R нагревателя Ом");
